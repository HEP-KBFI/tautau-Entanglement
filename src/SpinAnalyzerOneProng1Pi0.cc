...
namespace
{
                                     ...
                                     const ROOT::Math::Boost& boost_trf)
  {
    ...
    reco::Candidate::LorentzVector nuP4 = tauP4 - visTauP4;
    assert(nuP4.energy() >= 0.);
...
SpinAnalyzerOneProng1Pi0::operator()(const KinematicEvent& evt, int tau)
{
  ...
  reco::Candidate::Vector h = getPolarimetricVec_OneProng1PiZero(tauP4, *daughters, visTauP4, boost_ttrf, r, n, k, boost_trf);
  return h;
}
