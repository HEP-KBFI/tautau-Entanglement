#include "TauAnalysis/Entanglement/interface/PolarimetricA1.h"
...
PolarimetricA1::nTZLFr(){
  // CV: make sure that nTZLFr function never gets called, 
  //     because data-member _tauAlongZLabFrame does not get initialized anymore after my code changes !!
  assert(0);
