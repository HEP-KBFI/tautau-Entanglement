  ...
  for ( int idxSignTauPlus = 0; idxSignTauPlus <= 1; ++idxSignTauPlus )
  {
    ...
    for ( int idxSignTauMinus = 0; idxSignTauMinus <= 1; ++idxSignTauMinus )
    {
      ...
      while ( !hasConverged && iteration < max_iterations )
      {
        ...
        double nuTauPlusPz = comp_nuPz(visTauPlusP4, nuTauPlusPx, nuTauPlusPy, signTauPlus, nuTauPlus_dPzdPx, nuTauPlus_dPzdPy, verbosity_);
        ...
        double nuTauMinusPz = comp_nuPz(visTauMinusP4, nuTauMinusPx, nuTauMinusPy, signTauMinus, nuTauMinus_dPzdPx, nuTauMinus_dPzdPy, verbosity_);
        ...
        D(0,3) = ((tauMinusE/tauPlusE)*(tauPlusPx  + nuTauPlus_dPzdPx*tauPlusPz)   - tauMinusPx - nuTauPlus_dPzdPx*tauMinusPz)/denominator0; // dH/dnuTauPlusPx
        D(0,4) = ((tauMinusE/tauPlusE)*(tauPlusPy  + nuTauPlus_dPzdPy*tauPlusPz)   - tauMinusPy - nuTauPlus_dPzdPy*tauMinusPz)/denominator0; // dH/dnuTauPlusPy
        D(0,8) = ((tauPlusE/tauMinusE)*(tauMinusPx + nuTauMinus_dPzdPx*tauMinusPz) - tauPlusPx  - nuTauMinus_dPzdPx*tauPlusPz)/denominator0; // dH/dnuTauMinusPx
        D(0,9) = ((tauPlusE/tauMinusE)*(tauMinusPy + nuTauMinus_dPzdPy*tauMinusPz) - tauPlusPy  - nuTauMinus_dPzdPy*tauPlusPz)/denominator0; // dH/dnuTauMinusPy
        ...
        math::VectorP D1_1;
        D1_1(0) =  (1. - tauPlusDx/tauPlusDt)/tauPlusDy;                                                                                     // dH_Pphi/dpvX
        D1_1(1) = -(tauPlusDx/tauPlusDy)*D1_1(0);                                                                                            // dH_Pphi/dpvY
        D1_1(3) =  (1. - tauPlusPx/tauPlusPt)/tauPlusPy;                                                                                     // dH_Pphi/dnuTauPlusPx
        D1_1(4) = -(tauPlusPx/tauPlusPy)*D1_1(3);                                                                                            // dH_Pphi/dnuTauPlusPy     
        D1_1(5) = -D1_1(0);                                                                                                                  // dH_Pphi/dsvTauPlusX
        D1_1(6) = -D1_1(1);                                                                                                                  // dH_Pphi/dsvTauPlusY
        double D1_1_mag = comp_mag(D1_1);
        math::VectorP D1_2;
        D1_2(0) = -(tauPlusDy/tauPlusDx)*(1. - tauPlusDy/tauPlusDt)/tauPlusDx;                                                               // dH_Pphi/dpvX
        D1_2(1) =  (1. - tauPlusDy/tauPlusDt)/tauPlusDx;                                                                                     // dH_Pphi/dpvY
        D1_2(3) = -(tauPlusPy/tauPlusPx)*(1. - tauPlusPy/tauPlusPt)/tauPlusPx;                                                               // dH_Pphi/dnuTauPlusPx
        D1_2(4) =  (1. - tauPlusPy/tauPlusPt)/tauPlusPx;                                                                                     // dH_Pphi/dnuTauPlusPy
        D1_2(5) = -D1_2(0);                                                                                                                  // dH_Pphi/dsvTauPlusX
        D1_2(6) = -D1_2(1);                                                                                                                  // dH_Pphi/dsvTauPlusY
        ...
        if ( D1_1_mag < D1_2_mag )
        {
          ...
          d(1) = (tauPlusDt - tauPlusDx)/tauPlusDy + (tauPlusPx - tauPlusPt)/tauPlusPy;
        }
        else
        {
          for ( int idx = 0; idx < kinFit::numParameters; ++idx )
          ...
          d(1) = (tauPlusDt - tauPlusDy)/tauPlusDx + (tauPlusPy - tauPlusPt)/tauPlusPx;
        }
        math::VectorP D2_1;
        D2_1(0) =  (tauPlusDx/tauPlusDz)*(1./tauPlusDt - 1./tauPlusD);                                                                       // dH_Ptheta/dpvX
        D2_1(1) =  (tauPlusDy/tauPlusDz)*(1./tauPlusDt - 1./tauPlusD);                                                                       // dH_Ptheta/dpvY
        D2_1(2) = -1./tauPlusD + (tauPlusD - tauPlusDt)/square(tauPlusDz);                                                                   // dH_Ptheta/dpvZ
        D2_1(3) =  (1./square(tauPlusPz))*nuTauPlus_dPzdPx*(tauPlusP - tauPlusPt)                                                            // dH_Ptheta/dnuTauPlusPx
                   + (1./tauPlusPz)*(tauPlusPx/tauPlusPt - (tauPlusPx + nuTauPlus_dPzdPx*tauPlusPz)/tauPlusP);
        D2_1(4) =  (1./square(tauPlusPz))*nuTauPlus_dPzdPy*(tauPlusP - tauPlusPt)                                                            // dH_Ptheta/dnuTauPlusPy
                   + (1./tauPlusPz)*(tauPlusPy/tauPlusPt - (tauPlusPy + nuTauPlus_dPzdPy*tauPlusPz)/tauPlusP);
        D2_1(5) = -D2_1(0);                                                                                                                  // dH_Ptheta/dsvTauPlusX
        D2_1(6) = -D2_1(1);                                                                                                                  // dH_Ptheta/dsvTauPlusY
        D2_1(7) = -D2_1(2);                                                                                                                  // dH_Ptheta/dsvTauPlusZ
        double D2_1_mag = comp_mag(D2_1);
        math::VectorP D2_2;
        D2_2(0) = -(tauPlusDx*tauPlusDz/cube(tauPlusDt))*(1. - tauPlusDz/tauPlusD);                                                          // dH_Ptheta/dpvX
        D2_2(1) = -(tauPlusDy*tauPlusDz/cube(tauPlusDt))*(1. - tauPlusDz/tauPlusD);                                                          // dH_Ptheta/dpvY
        D2_2(2) =  (1. - tauPlusDz/tauPlusD)/tauPlusDt;                                                                                      // dH_Ptheta/dpvZ
        D2_2(3) =  (tauPlusPx/cube(tauPlusPt))*(tauPlusP - tauPlusPz)                                                                        // dH_Ptheta/dnuTauPlusPx
                   + (1./tauPlusPt)*(nuTauPlus_dPzdPx - (tauPlusPx + nuTauPlus_dPzdPx*tauPlusPz)/tauPlusP);
        D2_2(4) =  (tauPlusPy/cube(tauPlusPt))*(tauPlusP - tauPlusPz)                                                                        // dH_Ptheta/dnuTauPlusPy
                   + (1./tauPlusPt)*(nuTauPlus_dPzdPy - (tauPlusPy + nuTauPlus_dPzdPy*tauPlusPz)/tauPlusP);
        D2_2(5) = -D2_2(0);                                                                                                                  // dH_Ptheta/dsvTauPlusX
        D2_2(6) = -D2_2(1);                                                                                                                  // dH_Ptheta/dsvTauPlusY
        D2_2(7) = -D2_2(2);                                                                                                                  // dH_Ptheta/dsvTauPlusZ
        ...
        if ( D2_1_mag < D2_2_mag )
        {
          ...
          d(2) = (tauPlusD - tauPlusDt)/tauPlusDz + (tauPlusPt - tauPlusP)/tauPlusPz;
        }
        else
        {
          for ( int idx = 0; idx < kinFit::numParameters; ++idx )
          ...
          d(2) = (tauPlusD - tauPlusDz)/tauPlusDt + (tauPlusPz - tauPlusP)/tauPlusPt;
        }
        // CV: add "parallelism" constraint for tau-
        //     The constraint equations H_Pphi and H_Ptheta are given by Eqs. (4.10) and (4.11)
        //     in Section 4.1.3.3 of [1].
        ...
        //   [1] https://cds.cern.ch/record/1358627/files/CERN-THESIS-2011-028.pdf
        math::VectorP D3_1;
        D3_1( 0) =  (1. - tauMinusDx/tauMinusDt)/tauMinusDy;                                                                                 // dH_Pphi/dpvX
        D3_1( 1) = -(tauMinusDx/tauMinusDy)*D3_1(0);                                                                                         // dH_Pphi/dpvY
        D3_1( 8) =  (1. - tauMinusPx/tauMinusPt)/tauMinusPy;                                                                                 // dH_Pphi/dnuTauMinusPx
        D3_1( 9) = -(tauMinusPx/tauMinusPy)*D3_1(8);                                                                                         // dH_Pphi/dnuTauMinusPy
        D3_1(10) = -D3_1(0);                                                                                                                 // dH_Pphi/dsvTauMinusX
        D3_1(11) = -D3_1(1);                                                                                                                 // dH_Pphi/dsvTauMinusY
        double D3_1_mag = comp_mag(D3_1);
        math::VectorP D3_2;
        D3_2( 0) = -(tauMinusDy/tauMinusDx)*(1. - tauMinusDy/tauMinusDt)/tauMinusDx;                                                         // dH_Pphi/dpvX
        D3_2( 1) =  (1. - tauMinusDy/tauMinusDt)/tauMinusDx;                                                                                 // dH_Pphi/dpvY
        D3_2( 8) = -(tauMinusPy/tauMinusPx)*(1. - tauMinusPy/tauMinusPt)/tauMinusPx;                                                         // dH_Pphi/dnuTauMinusPx
        D3_2( 9) =  (1. - tauMinusPy/tauMinusPt)/tauMinusPx;                                                                                 // dH_Pphi/dnuTauMinusPy
        D3_2(10) = -D3_2(0);                                                                                                                 // dH_Pphi/dsvTauMinusX
        D3_2(11) = -D3_2(1);                                                                                                                 // dH_Pphi/dsvTauMinusY
        ...
        if ( D3_1_mag < D3_2_mag )
        {
          ...
          d(3) =  (tauMinusDt - tauMinusDx)/tauMinusDy + (tauMinusPx - tauMinusPt)/tauMinusPy;
        }
        else
        {
          for ( int idx = 0; idx < kinFit::numParameters; ++idx )
          ...
          d(3) =  (tauMinusDt - tauMinusDy)/tauMinusDx + (tauMinusPy - tauMinusPt)/tauMinusPx;
        }
        math::VectorP D4_1;
        D4_1( 0) =  (tauMinusDx/tauMinusDz)*(1./tauMinusDt - 1./tauMinusD);                                                                  // dH_Ptheta/dpvX
        D4_1( 1) =  (tauMinusDy/tauMinusDz)*(1./tauMinusDt - 1./tauMinusD);                                                                  // dH_Ptheta/dpvY
        D4_1( 2) = -1./tauMinusD + (tauMinusD - tauMinusDt)/square(tauMinusDz);                                                              // dH_Ptheta/dpvZ
        D4_1( 8) =  (1./square(tauMinusPz))*nuTauMinus_dPzdPx*(tauMinusP - tauMinusPt)                                                       // dH_Ptheta/dnuTauMinusPx
                   + (1./tauMinusPz)*(tauMinusPx/tauMinusPt - (tauMinusPx + nuTauMinus_dPzdPx*tauMinusPz)/tauMinusP);
        D4_1( 9) =  (1./square(tauMinusPz))*nuTauMinus_dPzdPy*(tauMinusP - tauMinusPt)                                                       // dH_Ptheta/dnuTauMinusPy
                   + (1./tauMinusPz)*(tauMinusPy/tauMinusPt - (tauMinusPy + nuTauMinus_dPzdPy*tauMinusPz)/tauMinusP);
        D4_1(10) = -D4_1(0);                                                                                                                 // dH_Ptheta/dsvTauMinusX
        D4_1(11) = -D4_1(1);                                                                                                                 // dH_Ptheta/dsvTauMinusY
        D4_1(12) = -D4_1(2);                                                                                                                 // dH_Ptheta/dsvTauMinusZ
        double D4_1_mag = comp_mag(D4_1);
        math::VectorP D4_2;
        D4_2( 0) = -(tauMinusDx*tauMinusDz/cube(tauMinusDt))*(1. - tauMinusDz/tauMinusD);                                                    // dH_Ptheta/dpvX
        D4_2( 1) = -(tauMinusDy*tauMinusDz/cube(tauMinusDt))*(1. - tauMinusDz/tauMinusD);                                                    // dH_Ptheta/dpvY
        D4_2( 2) =  (1. - tauMinusDz/tauMinusD)/tauMinusDt;                                                                                  // dH_Ptheta/dpvZ
        D4_2( 8) = (tauMinusPx/cube(tauMinusPt))*(tauMinusP - tauMinusPz)                                                                    // dH_Ptheta/dnuTauMinusPx
                   + (1./tauMinusPt)*(nuTauMinus_dPzdPx - (tauMinusPx + nuTauMinus_dPzdPx*tauMinusPz)/tauMinusP);
        D4_2( 9) = (tauMinusPy/cube(tauMinusPt))*(tauMinusP - tauMinusPz)                                                                    // dH_Ptheta/dnuTauMinusPy
                   + (1./tauMinusPt)*(nuTauMinus_dPzdPy - (tauMinusPy + nuTauMinus_dPzdPy*tauMinusPz)/tauMinusP);
        D4_2(10) = -D4_2(0);                                                                                                                 // dH_Ptheta/dsvTauMinusX
        D4_2(11) = -D4_2(1);                                                                                                                 // dH_Ptheta/dsvTauMinusY
        D4_2(12) = -D4_2(2);                                                                                                                 // dH_Ptheta/dsvTauMinusZ
        double D4_2_mag = comp_mag(D4_2);
        if ( verbosity_ >= 1 )
        {
          std::cout << "D4 (1st):\n";
          std::cout << D4_1 << "\n";
          std::cout << " mag = " << D4_1_mag << "\n";
          std::cout << "D4 (2nd):\n";
          std::cout << D4_2 << "\n";
          std::cout << " mag = " << D4_2_mag << "\n";
        }
        if ( D4_1_mag < D4_2_mag )
        {
          for ( int idx = 0; idx < kinFit::numParameters; ++idx )
          {
            D(4,idx) = D4_1(idx);
          }
          d(4) =  (tauMinusD - tauMinusDt)/tauMinusDz + (tauMinusPt - tauMinusP)/tauMinusPz;
        }
        else
        {
          for ( int idx = 0; idx < kinFit::numParameters; ++idx )
          ...
          d(4) =  (tauMinusD - tauMinusDz)/tauMinusDt + (tauMinusPz - tauMinusP)/tauMinusPt;
        }
        ...
        //       nuTauPlusE  = sqrt(nuTauPlusPx^2  + nuTauPlusPy^2  + nuTauPlusPz^2 )
        //       nuTauMinusE = sqrt(nuTauMisusPx^2 + nuTauMinusPy^2 + nuTauMinusPz^2)
        D(5, 3) = +1.;                                                                                                                       // dH_px/dnuTauPlusPx
        D(5, 8) = +1.;                                                                                                                       // dH_px/dnuTauMinusPx
        D(5,13) = -1.;                                                                                                                       // dH_px/drecoilPx
        d(5) = tauPlusPx + tauMinusPx - recoilPx;
        D(6, 4) = +1.;                                                                                                                       // dH_py/dnuTauPlusPy
        D(6, 9) = +1.;                                                                                                                       // dH_py/dnuTauMinusPy
        D(6,14) = -1.;                                                                                                                       // dH_py/drecoilPy
        d(6) = tauPlusPy + tauMinusPy - recoilPy;
        D(7, 3) = nuTauPlus_dPzdPx;                                                                                                          // dH_pz/dnuTauPlusPx
        D(7, 4) = nuTauPlus_dPzdPy;                                                                                                          // dH_pz/dnuTauPlusPy
        D(7, 8) = nuTauMinus_dPzdPx;                                                                                                         // dH_pz/dnuTauMinusPx
        D(7, 9) = nuTauMinus_dPzdPy;                                                                                                         // dH_pz/dnuTauMinusPy
        D(7,15) = -1.;                                                                                                                       // dH_pz/drecoilPz
        d(7) = visTauPlusPz + nuTauPlusPz + visTauMinusPz + nuTauMinusPz - recoilPz;
        D(8, 3) = (tauPlusPx  + nuTauPlus_dPzdPx*tauPlusPz)/tauPlusE;                                                                        // dH_energy/dnuTauPlusPx
        D(8, 4) = (tauPlusPy  + nuTauPlus_dPzdPy*tauPlusPz)/tauPlusE;                                                                        // dH_energy/dnuTauPlusPx
        D(8, 8) = (tauMinusPx + nuTauMinus_dPzdPx*tauMinusPz)/tauMinusE;                                                                     // dH_energy/dnuTauPlusPx
        D(8, 9) = (tauMinusPy + nuTauMinus_dPzdPy*tauMinusPz)/tauMinusE;                                                                     // dH_energy/dnuTauPlusPx
        D(8,16) = -1.;                                                                                                                       // dH_energy/drecoilE
        d(8) = tauPlusE + tauMinusE - recoilE;
        if ( verbosity_ >= 1 )
        {
          std::cout << "D:\n";
          std::cout << D << "\n";
        ...
        kineEvtA.recoilCov_ = V_alpha.Sub<math::Matrix4x4>(13,13);
        double nuTauPlusPxA = alpha(3);
        double nuTauPlusPyA = alpha(4);
        double nuTauPlus_dPzdPxA, nuTauPlus_dPzdPyA;
        double nuTauPlusPzA = comp_nuPz(visTauPlusP4, nuTauPlusPxA, nuTauPlusPyA, signTauPlus, nuTauPlus_dPzdPxA, nuTauPlus_dPzdPyA, verbosity_);
        kineEvtA.nuTauPlusP4_ = build_nuP4(nuTauPlusPxA, nuTauPlusPyA, nuTauPlusPzA);
        kineEvtA.nuTauPlusP4_isValid_ = true;
        kineEvtA.nuTauPlusCov_ = build_nuCov(V_alpha.Sub<math::Matrix2x2>(3,3), nuTauPlus_dPzdPxA, nuTauPlus_dPzdPyA);
        ...
        kineEvtA.svTauPlusCov_ = V_alpha.Sub<math::Matrix3x3>(5,5);
        double nuTauMinusPxA = alpha(8);
        double nuTauMinusPyA = alpha(9);
        double nuTauMinus_dPzdPxA, nuTauMinus_dPzdPyA;
        double nuTauMinusPzA = comp_nuPz(visTauMinusP4, nuTauMinusPxA, nuTauMinusPyA, signTauMinus, nuTauMinus_dPzdPxA, nuTauMinus_dPzdPyA, verbosity_);
        kineEvtA.nuTauMinusP4_ = build_nuP4(nuTauMinusPxA, nuTauMinusPyA, nuTauMinusPzA);
        kineEvtA.nuTauMinusP4_isValid_ = true;       
        kineEvtA.nuTauMinusCov_ = build_nuCov(V_alpha.Sub<math::Matrix2x2>(8,8), nuTauMinus_dPzdPxA, nuTauMinus_dPzdPyA);
        ...
        kineEvtA.svTauMinusCov_ = V_alpha.Sub<math::Matrix3x3>(10,10);
        if ( verbosity_ >= 1 )
        {
