...
spin::Measurement
SpinAlgo_by_differentialXsec2d::operator()(const spin::Dataset& dataset)
{
  if ( verbosity_ >= 3 )
  {
  ...
  math::Matrix3x3 C;
  C(0,0) = fit_DifferentialXsec2d_C(C_rr, verbosity_);
  C(0,1) = fit_DifferentialXsec2d_C(C_rn, verbosity_);
  C(0,2) = fit_DifferentialXsec2d_C(C_rk, verbosity_);
  C(1,0) = fit_DifferentialXsec2d_C(C_nr, verbosity_);
  C(1,1) = fit_DifferentialXsec2d_C(C_nn, verbosity_);
  C(1,2) = fit_DifferentialXsec2d_C(C_nk, verbosity_);
  C(2,0) = fit_DifferentialXsec2d_C(C_kr, verbosity_);
  C(2,1) = fit_DifferentialXsec2d_C(C_kn, verbosity_);
