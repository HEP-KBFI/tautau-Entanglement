...
//--- read python configuration parameters
  ...
  for ( size_t idxInputFile = 0; idxInputFile < numInputFiles && !STOP; ++idxInputFile )
  {
    ...
    inputTree->SetBranchAddress("gen_tauPlus_tip", &gen_tauPlus_tip);
    ...
    inputTree->SetBranchAddress("gen_tauMinus_tip", &gen_tauMinus_tip);
    ...
    inputTree->SetBranchAddress(Form("%s_tauPlus_tip", mode.c_str()), &rec_tauPlus_tip);
    ...
    inputTree->SetBranchAddress(Form("%s_tauMinus_tip", mode.c_str()), &rec_tauMinus_tip);
  ...
  showHistogram1d(histogram_res_tauPlus_tip,            "#tau^{+} d_{IP}^{rec} - d_{IP}^{gen}",                      1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
  ...
  showHistogram1d(histogram_res_tauMinus_tip,           "#tau^{-} d_{IP}^{rec} - d_{IP}^{gen}",                      1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
  ...
  showHistogram1d(histogram_res_hPlus_r_times_hMinus_r, "h_{r}^{+,rec}*h_{r}^{-,rec} - h_{r}^{+,gen}*h_{r}^{-,gen}", 1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
  showHistogram1d(histogram_res_hPlus_r_times_hMinus_n, "h_{r}^{+,rec}*h_{n}^{-,rec} - h_{r}^{+,gen}*h_{n}^{-,gen}", 1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
  showHistogram1d(histogram_res_hPlus_r_times_hMinus_k, "h_{r}^{+,rec}*h_{k}^{-,rec} - h_{r}^{+,gen}*h_{k}^{-,gen}", 1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
  showHistogram1d(histogram_res_hPlus_n_times_hMinus_r, "h_{n}^{+,rec}*h_{r}^{-,rec} - h_{n}^{+,gen}*h_{r}^{-,gen}", 1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
  showHistogram1d(histogram_res_hPlus_n_times_hMinus_n, "h_{n}^{+,rec}*h_{n}^{-,rec} - h_{n}^{+,gen}*h_{n}^{-,gen}", 1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
  showHistogram1d(histogram_res_hPlus_n_times_hMinus_k, "h_{n}^{+,rec}*h_{k}^{-,rec} - h_{n}^{+,gen}*h_{k}^{-,gen}", 1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
  showHistogram1d(histogram_res_hPlus_k_times_hMinus_r, "h_{k}^{+,rec}*h_{r}^{-,rec} - h_{k}^{+,gen}*h_{r}^{-,gen}", 1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
  showHistogram1d(histogram_res_hPlus_k_times_hMinus_n, "h_{k}^{+,rec}*h_{n}^{-,rec} - h_{k}^{+,gen}*h_{n}^{-,gen}", 1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
  showHistogram1d(histogram_res_hPlus_k_times_hMinus_k, "h_{k}^{+,rec}*h_{k}^{-,rec} - h_{k}^{+,gen}*h_{k}^{-,gen}", 1.2, true, 1.e-3, 1.e0, "Events", 1.3, avEvtWeight, true,  outputFile.file());
